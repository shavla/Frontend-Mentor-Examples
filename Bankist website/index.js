...
// const inialCoords = section1.getBoundingClientRect();
// window.addEventListener("scroll", function () {
//   if (window.scrollY > inialCoords.top) nav.classList.add("sticky");
...
const revealSection = function (entries, observer) {
  ...
  entri.target.classList.remove("section--hidden");
